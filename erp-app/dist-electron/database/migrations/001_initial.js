...
exports.migration_001_initial = migration_001_initial;
function migration_001_initial(db) {
    ...
    CREATE TABLE IF NOT EXISTS device_config (
      ...
      company_cnss TEXT DEFAULT '',
      company_bank_name TEXT DEFAULT '',
      company_bank_rib TEXT DEFAULT '',
      company_bank_account TEXT DEFAULT '',
      company_capital TEXT DEFAULT '',
      company_legal_form TEXT DEFAULT '',
      company_city TEXT DEFAULT '',
      company_country TEXT DEFAULT 'Maroc',
      company_logo TEXT,
